...
你可以在下面看到一个包含完整注释和正确标记的addon.xml，可通过它为你自己的插件写addon.xml。

你可以在[插件机制](https://github.com/jason-wong/documents_translate/blob/master/CMS/CS-Cart-Developer-Documentation/add-on-scheme.md)章节中找到更多关于所有元素的描述。

下载[addon.xml](http://docs.cs-cart.com/index.php?dispatch=docs.getfile&attachment_id=86634)
...
从CS-Cart 3开始，上面的插件机制将不再支持。

使用详细的方案描述结合上述描述新方案将旧插件适应新版本。

下载[addon.xml.old](http://docs.cs-cart.com/index.php?dispatch=docs.getfile&attachment_id=86635)
